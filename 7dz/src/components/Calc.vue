<template>
  <div class="calculator">
    ...
    <div v-if="showvk">
      ...
      <button v-for="btn in 10" :name="'num' + (btn - 1)" :key="btn" @click="inputNum(btn - 1)">
        {{ btn - 1 }}
      </button>
      <button name="erase" @click="eraseOne">E</button>
      <br /><br />
      <label><input type="radio" name="op1" value="1" v-model="operch" />Операнд 1</label>
      <label><input type="radio" name="op2" value="2" v-model="operch" />Операнд 2</label>
    </div>
  </div>
</template>
